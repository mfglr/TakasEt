...
export const followUserAction = createAction("[User Store] follow user",props<{userId : number}>())
export const followerUserSuccessAction = createAction(
  "[User Store] follow user success",
  props<{userId : number}>()
)
