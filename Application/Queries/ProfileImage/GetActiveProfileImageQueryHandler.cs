...
{
    public class GetActiveProfileImageQueryHandler : IRequestHandler<GetActiveProfileImage, byte[]>
    {
        private readonly IFileWriterService _writerService;
        private readonly IBlobService _blobService;
        private readonly UserManager<User> _userManager;

        public GetActiveProfileImageQueryHandler(IFileWriterService writerService, IBlobService blobService, IRepository<ProfileImage> profileImages, UserManager<User> userManager)
        {
        ...
        public async Task<byte[]> Handle(GetActiveProfileImage request, CancellationToken cancellationToken)
        {
