...
namespace Repository.Migrations
{
    ...
    [Migration("20240130174149_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.ConversationUserRemoving", b =>
                {
                    b.Property<int>("SenderId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SenderId", "ReceiverId", "RemoverId");
            ...
            modelBuilder.Entity("Models.Entities.GroupImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Entities.MessageHubState", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Entities.MessageUserRemoving", b =>
                {
                    b.Property<int>("MessageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Entities.RoleUser", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.ConversationUserRemoving", b =>
                {
                    b.HasOne("Models.Entities.User", "Remover")
                        .WithMany("ConversationsRemoved")
                        .HasForeignKey("RemoverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Models.Entities.Conversation", "Conversation")
                        .WithMany("UsersWhoRemoved")
                        .HasForeignKey("SenderId", "ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.Entities.MessageHubState", b =>
                {
                    b.HasOne("Models.Entities.User", "User")
                        .WithOne("MessageHubState")
                        .HasForeignKey("Models.Entities.MessageHubState", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.Entities.UserUserViewing", b =>
                {
                    b.HasOne("Models.Entities.User", "Viewed")
                        .WithMany("UsersWhoViewed")
                        .HasForeignKey("ViewedId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Models.Entities.User", "Viewer")
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Navigation("ConversationsRemoved");

                    b.Navigation("ConversationsSent");
                    ...
                    b.Navigation("MessageHubState");

                    b.Navigation("MessagesRemoved");
