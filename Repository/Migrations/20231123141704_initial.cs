    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6834), "Kitap", "KITAP", null },
                    { 2, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6848), "Araba", "ARABA", null },
                    { 3, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6849), "Elektronik", "ELEKTRONIK", null },
                    { 4, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6849), "Giyim", "GIYIM", null },
                    { 5, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6850), "Ev Eşyaları", "EV ESYALARI", null },
                    { 6, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6851), "Telefon", "TELEFON", null },
                    { 7, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6851), "Bilgisayar", "BILGISAYAR", null },
                    { 8, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(6852), "Motor", "MOTOR", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(7078), "client", null },
                    { 2, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(7082), "user", null },
                    { 3, new DateTime(2023, 11, 23, 17, 17, 4, 562, DateTimeKind.Local).AddTicks(7083), "admin", null }
                });
