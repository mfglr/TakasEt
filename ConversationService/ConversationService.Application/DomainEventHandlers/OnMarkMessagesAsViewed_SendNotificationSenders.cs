...
{
    public class OnMarkMessagesAsViewed_SendNotificationSenders : INotificationHandler<MessagesMarkedAsViewedDomainEvent>
    {

        private readonly IHubContext<ConversationHub> _conversationHub;
        private readonly AppDbContext _context;

        public OnMarkMessagesAsViewed_SendNotificationSenders(IHubContext<ConversationHub> conversationHub, AppDbContext context)
        {
